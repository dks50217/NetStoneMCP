...
namespace NetStoneMCP.Tools
{
    ...
    public class CollectTool(IFFXIVCollectService collectService, ILogger<CollectTool> logger)
    {
        ...
        {
            return await _collectService.SearchMountsAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectItemDto>?> GetMinion(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchMinionsAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectItemDto>?> GetEmote(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchEmotesAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectItemDto>?> GetHairstyle(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchHairstylesAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectItemDto>?> GetOrchestrion(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchOrchestrionsAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectItemDto>?> GetBlueMageSpell(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchSpellsAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectItemDto>?> GetBarding(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchBardingsAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectItemDto>?> GetFashion(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchFashionsAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectAchievementDto>?> GetAchievement(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchAchievementsAsync(name, cancellationToken);
        }
        ...
        public async Task<IEnumerable<CollectItemDto>?> SearchCollectable(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _collectService.SearchCollectablesAsync(category, name, cancellationToken);
        }
    }
}
